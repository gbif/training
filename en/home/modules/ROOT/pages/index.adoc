...
* xref:data-mobilization::index.adoc[image:Courses-04.png[]]
** xref:data-mobilization::index.adoc[Accelerating biodiversity research through DNA barcodes, collection and observation data]
// ** lorem ipsum
...
** xref:epn::index.adoc[Establishing a GBIF Participant Node]
// ** lorem ipsum
