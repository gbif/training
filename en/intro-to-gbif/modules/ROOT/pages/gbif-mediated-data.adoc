...
If you are unable to watch the embedded Vimeo video, you can xref:attachment$how_data_is_shared_with_gbif._v1_1080p.mp4[download] it locally (MP4 - 39.4 MB).
====
...
image::intro-to-gbif::QDataTypes-types.png[align="center", width="640"]

* Metadata only - datasets describing *undigitized* resources like those in natural history and other collections
...
image::intro-to-gbif::backbone.png[align="center", width="640"]
