...
This video (03:19) was originally co-produced in Spanish (https://vimeo.com/236573907) by SiB Colombia and GBIF Spain, both national nodes of GBIF, and Go Visual with co-financing from GBIF Spain and the Alexander von Humboldt Biological Resources Research Institute (IAvH), the host institution of SiB Colombia.
