...
Based on the principles that Arthur Chapman discusses in the https://www.gbif.org/document/80509/principles-of-data-quality[_Principles of Data Quality_^] (2005), you must reflect on some important questions about the data to help you decide if data is trustworthy or useful enough for your purpose: 
