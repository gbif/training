...
*Step 3*: Using the filter “Country or area of researcher”, filter these results to your own country. You are now seeing all tracked examples of journal articles that cite the use of GBIF-mediated data for which at least one of the authors is affiliated with an institution from your country.
