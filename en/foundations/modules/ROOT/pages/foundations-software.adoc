...
During the Biodiversity Data Mobilization course activities, we’ll demonstrate and work with many different software tools related to data digitization, data quality and transformation. You probably already use several of them in your daily work.
...
Download xref:attachment$Software-database-EN.xlsx[Software-database-EN.xlsx,opts=download]. (23 KB)
...
They are inspired by the chapter “characteristics of a good database solution” of the GBIF manual https://www.gbif.org/document/80574/initiating-a-collection-digitisation-project[_Initiating a Digitisation Project_^]:
