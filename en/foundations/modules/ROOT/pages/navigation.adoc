...
image::intro-to-gbif::transcript.png[align=left,width=65%,height=65%]

== Left navigation

You will find the course navigation on the left side of the page. Some of the menu items expand/collapse.

image::intro-to-gbif::left-nav.png[align=left,width=50%,height=50%]
...
image::intro-to-gbif::right-nav.png[align=left,width=65%,height=65%]
...
image::intro-to-gbif::course-bottom-nav.png[]
