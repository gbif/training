...
[NOTE.install]
====
If you plan to complete the _Biodiversity Data Mobilization_ course, you will need to install OpenRefine.
====

image::foundations::open-refine-logo.png[Open Refine Logo,width=255px,height=62px,align=center]
...
We will use OpenRefine during the data management portion of the course, especially during the practical exercises.
...
NOTE: Remember to look for the most recent stable release. Keep in mind that screenshots below may differ on newer releases. Detailed installation instructions are available at https://docs.openrefine.org/manual/installing/[^].

== Installation on MS Windows

. Download the https://openrefine.org/download[Windows kit *with embedded Java*].  Choose to save the file rather than open it.
...
--
[.left]
image::foundations::win1-save-download.png[width=400]
Download the https://openrefine.org/download[Windows kit *with embedded Java*].  Choose to save the file rather than open it.
--
...
--
[.left]
image::foundations::win2-extract-all.png[width=400]
...
--
[.left]
image::foundations::win3-extract-location.png[width=400]
Click "Extract"
--
...
--
[.left]
image::foundations::win4-create-shortcut.png[width=400]
...
--
[.left]
image::foundations::win5-run.png[width=400]
...
. Download the https://openrefine.org/download[Mac kit].
...
--
[.left]
image::foundations::mac01-download-open.png[width=400]
Download the https://openrefine.org/download[Mac kit], and choose to open it.
--
...
--
[.left]
image::foundations::mac02-unidentified-developer.png[width=400]
...
--
[.left]
image::foundations::mac03-system-preferences.png[width=150]
...
--
[.left]
image::foundations::mac04-security-and-privacy.png[width=400]
...
--
[.left]
image::foundations::mac05-open-anyway.png[width=400]
...
--
[.left]
image::foundations::mac06-yes-really-open.png[width=400]
Choose "Open"
--
...
--
[.left]
image::foundations::mac07-copy-to-applications.png[width=400]
...
--
[.left]
image::foundations::mac08-who-owns-this-computer-anyway.png[width=400]
...
--
[.left]
image::foundations::mac09-not-the-user.png[width=400]
...
--
[.left]
image::foundations::mac10-use-linux-instead.png[width=400]
...
--
[.left]
image::foundations::mac11-run.png[width=400]
...
. Download the https://openrefine.org/download[Linux kit].
...
--
[.left]
image::foundations::kde1-download-open.png[width=400]
Download the https://openrefine.org/download[Linux kit].  Open it.
--
...
--
[.left]
image::foundations::kde2-extract.png[width=400]
...
--
[.left]
image::foundations::kde3-extract-all.png[width=400]
...
--
[.left]
image::foundations::kde4-open.png[width=400]
...
--
[.left]
image::foundations::kde5-execute.png[width=300]
...
--
[.left]
image::foundations::kde6-run.png[width=400]
