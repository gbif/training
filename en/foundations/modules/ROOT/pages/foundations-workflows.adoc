...
https://www.dissco.eu/[DiSSCo^] (Distributed System of Scientific Collections) maintains a series of digitization guides on their community hub. There is information on to best prepare collections for digitisation, how to digitize collections, and how then to publish the associated data.

* https://dissco.github.io/[DiSSCo Digitisation Guides^]
