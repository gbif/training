= Assignment - Dataset deliverables
[NOTE.assignments]

== Instructions
You are preparing to complete the dataset deliverables section of your full proposal. List any questions or uncertainties you encounter while completing this exercise that you would like to discuss during Module 3. 
