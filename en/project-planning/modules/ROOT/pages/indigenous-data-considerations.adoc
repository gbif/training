...
The group will engage in pilot studies, for example, looking at Local Contexts https://localcontexts.org/labels/about-the-labels[Traditional Knowledge and Biocultural Labels] which express conditions for sharing and engaging in future research that align with existing local rules, governance, and protocols on sharing and knowledge and data.
