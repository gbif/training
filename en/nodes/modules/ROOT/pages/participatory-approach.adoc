...
image::epn::ParticipatoryApproach.png[align=center,width=796,height=534]
...
In this final exercise, we will return to the context set out in the xref:use-case-darwinia.adoc[use case] for the fictitious country of Darwinia and assume that you were successful in gaining the attention of the Ministry with your pitch in Exercise 2. You will now be tasked to scope out a recommendation for the establishment of a Darwinia node. 
...
[NOTE.activity]
====
In your your exercise 3 sheet (available on the xref:downloads.adoc[Files for download] page), referring to the use case scenario, develop a recommendation for the establishment of a new Participant node in Darwinia. 
====
