...
[NOTE.description]
====
Overview on how to strengthen the capacity of node stakeholders by developing a strategic training plan, how to plan and organize a training, and requirements for an effective training. Will include the GBIF Secretariat training approach and guidance for nodes on training materials available for reuse. These materials were developed as part of the 2019 Global Nodes training in Leiden, Netherlands.
====
