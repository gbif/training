...
[NOTE.activity]
====
Develop and role play a pitch based on the xref:use-case-darwinia.adoc[use case] scenario for the fictitious country of Darwinia. 
Document your pitch in your exercise 2 sheet (available on the xref:downloads.adoc[Files for download] page).
...
*Step 4*: Upload your group's recording into the shared folder on the xref:assignments.adoc[final assignments] page.
