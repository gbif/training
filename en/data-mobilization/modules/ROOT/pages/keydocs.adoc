...
* https://rs.gbif.org/extensions.html[Darwin Core extensions registered with GBIF^]
...
* https://doi.org/10.35035/doc-0qzp-2x37[Best Practices for Managing and Publishing Camera Trap Data^] +
Reyserhove L, Norton B & Desmet P (2023).
* https://doi.org/10.35035/doc-ynvs-eh84[Guide for publishing biological survey and monitoring data to GBIF^] +
Ingenloff K, Svenningsen C, Earl C, Shimabukuro PHF, Sica Y, Gan Y-M, Kachian ZR, Brenton P, Hochachka W, Wieczorek J, Stevenson R, Kazem A, Baskauf S, Zermoglio PF, Bloom D, Rodrigues A, Gamboa Martínez J & Schigel D. (2025).
...
* https://github.com/SIB-Colombia/data-quality-open-refine/tree/master[Set of scripts in Open Refine for data quality^] Developed by SiB Colombia.
...
** https://biodiversidad.co/formacion/laboratorios/SpeciesMatching[Validación Taxonómica - Species Matching^]
