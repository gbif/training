...
image::data-mobilization::use-case-3-scanner.png[align=center,width=640,height=360]
...
image::data-mobilization::use-case-3-analogue.png[align=center,width=640,height=360]
...
image::data-mobilization::use-case-3-scanned.png[align=center,width=640,height=360]
...
Download the xref:attachment$UC3-DL-exercise-sheet_EN.docx[exercise sheet,opts=download]. (MS Word, 342 KB)
...
. Download xref:attachment$UC3-DL-3-ForCleaning.zip[UC3-DL-3-ForCleaning.zip,opts=download]. (45 KB)
...
. Download xref:attachment$UC3-DL-4-ForPublication.zip[UC3-DL-4-ForPublication.zip,opts=download]. (65 KB)
