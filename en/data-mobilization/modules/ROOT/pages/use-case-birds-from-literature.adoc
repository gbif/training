...
image::data-mobilization::use-case-BL-scanner.png[align=center,width=640,height=360]
...
image::data-mobilization::use-case-BL-analogue.png[align=center,width=640,height=360]
...
image::data-mobilization::use-case-BL-scanned.png[align=center,width=640,height=360]
...
Download the xref:attachment$UC-BL-exercise-sheet_EN.docx[exercise sheet,opts=download]. (MS Word, 2.8 MB)
...
. Download xref:attachment$UC3-BL-2-ForCleaning.zip[UC-BL-2-ForCleaning.zip,opts=download]. (45 KB)
...
. Download xref:attachment$UC3-BL-3-ForPublication.zip[UC-BL-3-ForPublication.zip,opts=download]. (65 KB)
