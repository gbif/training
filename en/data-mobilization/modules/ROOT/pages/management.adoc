...
<div class="responsive-slides">
  <iframe src="https://docs.google.com/presentation/d/e/2PACX-1vQ_gy0LdmnE1Pi-bbuAjBQzdSVlSrV8snykQY0q8G0aVjx76fiMiSJtPaHYCqNhGg/pubembed?start=false&loop=false" frameborder="0" allowfullscreen="true"></iframe>
</div>
++++
...
start=false&loop=false" frameborder="0" allowfullscreen="true"></iframe>
</div>
++++
...
[NOTE.activity]
====
For these exercises, you will perform technical and consistency validation checks, improve data with different tools.
====
...
++++
<div class="responsive-slides">
  <iframe src="https://docs.google.com/presentation/d/e/2PACX-1vSVDaNu7f19oZEZKfaUqqYKsHoSBgtegqHtvwW7l4TalCyDtzUeiLhGAKsoDOVuEA/pubembed?start=false&loop=false" frameborder="0" allowfullscreen="true"></iframe>
</div>
++++
