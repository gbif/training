...
[NOTE.presentation]
====
In this presentation, you will review an important set of principles necessary to improve data through the processes of data cleaning.
====
...
[NOTE.activity]
====
For this exercise, you will open a csv file in Excel (using the UTF-8 encoding) and then you will perform a series of validation checks to evaluate the file for errors.
====
...
. Download xref:attachment$UC-Practice-2ab-ForCleaning.csv[UC-Practice-2ab-ForCleaning.csv,opts=download]. (138 KB)
...
. Use the previously downloaded xref:attachment$UC-Practice-exercise-sheet_EN.docx[exercise sheet,opts=download] (PDF, 2.9 MB) to provide your answers.

== Data management tools

[NOTE.presentation]
====
In this presentation, you will learn about a variety of tools that you can use to improve the quality of your data.
====
...
++++
<div class="responsive-slides">
  <iframe src="https://docs.google.com/presentation/d/e/2PACX-1vSUp82spo2AXg8HwxYITBWETcY19lS55yWIc677MexvYVTB1r7pvAGCLGhmYKnzug/embed?start=false&loop=false" frameborder="0" allowfullscreen="true"></iframe>
</div>
++++
...
Image by https://pixabay.com/illustrations/developer-programmer-technology-3461405/[Mudassar Iqbal^] from Pixabay 
...
Photo:  Anas crecca subsp. crecca Observed in Japan by Yoshi.K. http://creativecommons.org/licenses/by-nc/4.0/[CC BY-NC 4.0^]
...
Photo: Asota egens subsp. confinis Rothschild, 1897 Observed in Japan by Takaaki Hattori http://creativecommons.org/licenses/by/4.0/[CC BY 4.0^]
...
Photo: Crepidiastrum lanceolatum (Houtt.) Nakai Observed in Japan by Takaaki Hattori http://creativecommons.org/licenses/by/4.0/[CC BY 4.0^]
...
Photo: Conus (Virroconus) ebraeus Linnaeus, 1758 Observed in Japan by Robert Guralnick http://creativecommons.org/licenses/by/4.0/[CC BY 4.0^]
...
Photo: Chelonia mydas (Linnaeus, 1758) Observed in Thailand by Michael Barth http://creativecommons.org/licenses/by-nc/4.0/[CC BY-NC 4.0^]
...
Photo: Microporus xanthopus (Fr.) Kuntze Observed in Thailand by Jacky http://creativecommons.org/licenses/by-nc/4.0/[CC BY-NC 4.0^]
...
Photo: Cheilinus fasciatus (Bloch, 1791) Observed in Thailand by Michael Barth http://creativecommons.org/licenses/by-nc/4.0/[CC BY-NC 4.0^]
...
[NOTE.presentation]
====
In this presentation, you will learn about https://openrefine.org/[OpenRefine^]. You can use OpenRefine to standardize and improve the quality of your data.
====
...
. Download lxref:attachment$UC-Practice-2c-OpenRefine.csv[UC-Practice-2c-OpenRefine.csv,opts=download]. (133 KB)
