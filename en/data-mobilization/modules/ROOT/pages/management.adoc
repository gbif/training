...
. Download xref:attachment$UC1-3ab-data-cleaning.csv[UC1-2ab-data-cleaning.csv,opts=download]. (207.5 KB)
...
. Download lxref:attachment$UC1-3c-open-refine.csv[UC1-2c-open-refine.csv,opts=download]. (207.5 KB)
. Download and complete the exercises in xref:attachment$OpenRefine-Exercise3c-EN.pdf[OpenRefine-Exercise2c-EN.pdf,opts=download]. (PDF, 1.1 MB)
Also available in xref:attachment$OpenRefine-Exercise3c-FR.pdf[French,opts=download] and xref:attachment$OpenRefine-Exercise3c-ES.pdf[Spanish,opts=download].
. Use the previously downloaded exercise sheet to provide your answers.
