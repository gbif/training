...
[NOTE.presentation]
====
In this video (09:49), you will review an important set of principles necessary to improve data through the processes of data cleaning based on the https://doi.org/10.15468/doc.jrgg-a190[Principles of Data Quality^], Chapman AD (2005). Subtitles for this video are available in French and Spanish.

If you are unable to watch the embedded video, you can xref:attachment$data_cleaning_concepts_v3-720p.mp4[download,opts=download] it locally. If you download it locally, subtitles are not available. (MP4 - 27.9 MB)

If you prefer to read, you will find the transcript below the embedded video.
====

[.responsive-video]
video::438251769[vimeo]
...
image::data-mobilization::management-cleaning-concepts-Slide1.png[align=center]
...
image::data-mobilization::management-cleaning-concepts-Slide2.png[align=center]
...
image::data-mobilization::management-cleaning-concepts-Slide3.png[align=center]
...
image::data-mobilization::management-cleaning-concepts-Slide4.png[align=center]
...
image::data-mobilization::management-cleaning-concepts-Slide5.png[align=center]
...
image::data-mobilization::management-cleaning-concepts-Slide6.png[align=center]
...
image::data-mobilization::management-cleaning-concepts-Slide7.png[align=center]
...
image::data-mobilization::management-cleaning-concepts-Slide8.png[align=center]
...
image::data-mobilization::management-cleaning-concepts-Slide9.png[align=center]
...
image::data-mobilization::management-cleaning-concepts-Slide10.png[align=center]
...
image::data-mobilization::management-cleaning-concepts-Slide11.png[align=center]
...
image::data-mobilization::management-cleaning-concepts-Slide12.png[align=center]
...
image::data-mobilization::management-cleaning-concepts-Slide13.png[align=center]
...
. Download xref:attachment$UC-Practice-2ab-ForCleaning.xlsx[UC-Practice-2ab-ForCleaning.xlsx,opts=download]. (43 KB)
...
. Use the previously downloaded xref:attachment$UC-Practice-exercise-sheet_EN.docx[exercise sheet,opts=download] (PDF, 4 MB) to provide your answers.

== Data management tools

[NOTE.presentation]
====
In this video (06:42), you will learn about a variety of tools that you can use to improve the quality of your data. Subtitles for this video are available in French and Spanish.

If you are unable to watch the embedded video, you can xref:attachment$data_cleaning_tools_v1-720p.mp4[download,opts=download] it locally. If you download it locally, subtitles are not available. (MP4 - 30.3 MB)

If you prefer to read, you will find the transcript below the embedded video.
====

[.responsive-video]
video::549885854[vimeo]
...
. Refer to <<Helpful tools>> in order to complete the exercise. It is suggested to use the https://www.gbif.org/tools/species-lookup[GBIF Species Matching tool^], the http://data.canadensys.net/tools/coordinates[Canadensys Coordinate Converter^] and http://splink.cria.org.br/infoxy?criaLANG=en[InfoXY^]. You are not limited to these tools, you may use any tools you like.
...
[NOTE.presentation]
====
In this video (03:27), you will learn about https://openrefine.org/[OpenRefine^]. You can use OpenRefine to standardize and improve the quality of your data. Subtitles for this video are available in French and Spanish.

If you are unable to watch the embedded video, you can xref:attachment$data_cleaning_using_openrefine_v3-720p.mp4[download,opts=download] it locally. If you download it locally, subtitles are not available. (MP4 - 7.7 MB)

If you prefer to read, you will find the transcript below the embedded video.
====

[.responsive-video]
video::549887717[vimeo]
...
. Download xref:attachment$UC-Practice-2c-OpenRefine.csv[UC-Practice-2c-OpenRefine.csv,opts=download]. (42 KB)
. Download and complete the exercises in xref:attachment$OpenRefine-Exercise2c-EN.pdf[OpenRefine-Exercise2c-EN.pdf,opts=download]. (PDF, 2.2 MB)
