...
image::data-mobilization::use-case-2-invasive-hawaii.png[align=center,width=640,height=360]
...
image::data-mobilization::use-case-2-invasives-data-collection.png[align=center,width=640]
...
Download the xref:attachment$UC2-IS-exercise-sheet_EN.docx[exercise sheet,opts=download]. (MS Word, 342 KB)
...
. Download xref:attachment$UC2-IS-2-ForCapture.csv[UC2-IS-2-ForCapture.csv,opts=download]. (7.1 MB)
...
. Download xref:attachment$UC2-IS-3-ForCleaning.xlsx[UC2-IS-3-ForCleaning.xlsx,opts=download]. (156 KB)
...
. Download xref:attachment$UC2-IS-4-ForPublication.xlsx[UC2-IS-4-ForPublication.xlsx,opts=download]. (99 KB) 
