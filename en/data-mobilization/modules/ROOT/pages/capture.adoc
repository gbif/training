...
. Download xref:attachment$UC1-2-base-material.zip[UC1-2-base-material.zip,opts=download]. (34.4 MB). There are 10 images. Two images per specimen for a total of five specimens. 
...
. Download the spreadsheet template: xref:attachment$UC1-2-occurrence-template.xlsx[UC1-2-occurrence-template.xlsx,opts=download] (57.3 KB) to transcribe the information found on each of the images for the five specimens. 
. Download xref:attachment$UC1-Herbarium-Exercise_EN.docx[UC1-Herbarium-Exercise_EN.docx,opts=download] to provide your answers.
