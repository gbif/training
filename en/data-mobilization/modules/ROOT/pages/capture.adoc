...
If you are unable to watch the embedded video, you can xref:attachment$data_capture,_processing_and_quality_v3-720p.mp4[download,opts=download] it locally. Subtitles are not yet available for this video. (MP4 - 42 MB)
