...
image::data-mobilization::use-case-2-Papilio_machaon.jpeg[align=center,width=640,height=360]
...
image::data-mobilization::use-case-2-lepidoptera-digital-1.png[align=center,width=640,height=360]
image::data-mobilization::use-case-2-lepidoptera-digital-2.png[align=center,width=640,height=360]

== Lepidoptera exercise sheet

Download the xref:attachment$UC2-LS-exercise-sheet_EN.docx[exercise sheet,opts=download]. (MS Word, 342 KB)
