...
. Download logs 1 and 2 xref:attachment$UC-LS-1-ForCapture.zip[UC-LS-1-ForCapture.zip]. (943 KB)
...
. Download xref:attachment$UC-LS-2-ForCleaning.xlsx[UC-LS-2-ForCleaning.xlsx]. (44 KB)
...
. Download xref:attachment$UC-LS-3-ForPublication.xlsx[UC-LS-3-ForPublication.xlsx]. (58 KB) 
