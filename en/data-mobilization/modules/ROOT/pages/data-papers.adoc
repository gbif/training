...
If you are unable to watch the embedded video, you can xref:attachment$Webinar_data_papers.mp4[download,opts=download] it locally. (MP4 - 99.2 MB)
====
...
image::data-mobilization::datapapers.png[align="center",width="640",height="471"]

image::data-mobilization::datapapersIPT.png[align="center",width="640",height="489"]
