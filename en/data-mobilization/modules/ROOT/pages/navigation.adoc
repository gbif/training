...
image::data-mobilization::transcript.png[align=left,width=65%,height=65%]

== Left navigation

You will find the course navigation on the left side of the page. Some of the menu items expand/collapse.

image::data-mobilization::left-nav.png[align=left,width=50%,height=50%]
...
image::data-mobilization::right-nav.png[align=left,width=65%,height=65%]
...
image::data-mobilization::course-bottom-nav.png[]
