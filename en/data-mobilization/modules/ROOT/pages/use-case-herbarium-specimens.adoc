...
Download the xref:attachment$UC-HS-exercise-sheet_EN.docx[exercise sheet,opts=download] (MS Word 345 KB).
...
. Download xref:attachment$UC-HS-2-data-cleaning.csv[UC-HS-2-data-cleaning.csv,opts=download]. (213 KB)
