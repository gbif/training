...
This Use Case is a practice use case for the data capture, data management and data publishing modules.

It is recommended that you download the xref:attachment$UC1-Herbarium-Exercise_EN.docx[exercise sheet,opts=download] (MS Word 345 KB) so that you can make notes as you work through the exercises. 
