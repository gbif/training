...
. Create a spreadsheet to transcribe the information found on each of the images for the five specimens. Consider additional fields where data can be derived from data on the logs.
