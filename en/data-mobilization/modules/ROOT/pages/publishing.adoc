...
[NOTE.presentation]
====
In this video (15:27), you will learn about data publishing concepts and will receive an introduction to the Integrated Publishing Toolkit (https://www.gbif.org/ipt[IPT^]). Subtitles are not yet available for this video.

If you are unable to watch the embedded video, you can xref:attachment$data_publishing_concepts_v2-720p.mp4[download,opts=download] it locally. (MP4 - 53.2 MB)

If you prefer to read, you will find the transcript below the embedded video.
====

[.responsive-video]
video::440142375[vimeo]
...
. Download xref:attachment$UC-Practice-3-ForPublication.xlsx[UC-Practice-3-ForPublication.xlsx,opts=download]. (22 KB)
