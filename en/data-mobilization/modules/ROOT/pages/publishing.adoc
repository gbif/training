...
Photo: Euphorbia royleana Boiss. Observed in Nepal by Yaling Lin (licensed under http://creativecommons.org/licenses/by-nc/4.0/)
...
Photo: Pieris formosa (Wall.) D.Don Observed in Nepal by Neil Alderson (licensed under http://creativecommons.org/publicdomain/zero/1.0/)
...
*Slide 14 - Explore the IPT*

As we finish up this presentation, we’d like for you to begin exploring the IPT.

Login and look around. 

In the next presentation, we will demonstrate how to use the IPT, after which you’ll be ready to try it yourself.
...
[NOTE.activity]
====
During this activity, you will log into an IPT.

If you have not already been provided a login, please contact training@gbif.org and you will be provided with a login and password to one of the training IPTs.
...
. Login to your assigned IPT and look around.

== IPT overview

[NOTE.presentation]
====
During this presentation you will receive an overview of the IPT data publishing interface.
====
...
[NOTE.presentation]
====
During this demonstration, you will learn how to publish an occurrence dataset using an IPT.
====
