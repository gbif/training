...
image::data-mobilization::open-refine-logo.png[Open Refine Logo,width=255px,height=62px,align=center]
...
--
[.left]
image::data-mobilization::win1-save-download.png[width=400]
Download the https://github.com/OpenRefine/OpenRefine/releases/download/3.4.1/openrefine-win-with-java-3.4.1.zip[Windows kit *with embedded Java*].  Choose to save the file rather than open it.
--
...
--
[.left]
image::data-mobilization::win2-extract-all.png[width=400]
...
--
[.left]
image::data-mobilization::win3-extract-location.png[width=400]
Click "Extract"
--
...
--
[.left]
image::data-mobilization::win4-create-shortcut.png[width=400]
...
--
[.left]
image::data-mobilization::win5-run.png[width=400]
...
--
[.left]
image::data-mobilization::mac01-download-open.png[width=400]
...
--
[.left]
image::data-mobilization::mac02-unidentified-developer.png[width=400]
...
--
[.left]
image::data-mobilization::mac03-system-preferences.png[width=150]
...
--
[.left]
image::data-mobilization::mac04-security-and-privacy.png[width=400]
...
--
[.left]
image::data-mobilization::mac05-open-anyway.png[width=400]
...
--
[.left]
image::data-mobilization::mac06-yes-really-open.png[width=400]
Choose "Open"
--
...
--
[.left]
image::data-mobilization::mac07-copy-to-applications.png[width=400]
...
--
[.left]
image::data-mobilization::mac08-who-owns-this-computer-anyway.png[width=400]
...
--
[.left]
image::data-mobilization::mac09-not-the-user.png[width=400]
...
--
[.left]
image::data-mobilization::mac10-use-linux-instead.png[width=400]
...
--
[.left]
image::data-mobilization::mac11-run.png[width=400]
...
--
[.left]
image::data-mobilization::kde1-download-open.png[width=400]
...
--
[.left]
image::data-mobilization::kde2-extract.png[width=400]
...
--
[.left]
image::data-mobilization::kde3-extract-all.png[width=400]
...
--
[.left]
image::data-mobilization::kde4-open.png[width=400]
...
--
[.left]
image::data-mobilization::kde5-execute.png[width=300]
...
--
[.left]
image::data-mobilization::kde6-run.png[width=400]
