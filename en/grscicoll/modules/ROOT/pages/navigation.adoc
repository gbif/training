...
You can obtain the content of each module either via video or written format. You will find the video transcripts below each video. Click to expand the transcript.

image::griscicoll::video-transcript.png[align=left,width=50%,height=50%]

== Left navigation

You will find the course navigation on the left side of the page. Some of the menu items expand/collapse.

image::griscicoll::left-nav.png[align=left,width=50%,height=50%]
...
image::grscicoll::right-nav.png[align=left,width=50%,height=50%]
