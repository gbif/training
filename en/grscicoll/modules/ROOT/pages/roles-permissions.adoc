...
*{sp}*Collections* with the master source from Index Hebrariorum can only be disconnected by administrators.

**{sp}*Machine* tags can only be added if the namespace is within permission scope.
--
====
